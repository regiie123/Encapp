...
<head>
    ...
    <title>Encryption | Multiple Encryption</title>
        ...
        <div class="input-container">
            <div class="input">
                <div class="form-group">
                    <form action="{{ url('/text_enc_enter') }}" method="post">
                    {!! csrf_field() !!}
                    @method("POST")
                    ...
                    @else
                        <div class="para">
                            <p>this is where encrypted code will show once submitted.</p>
                        </div>
                    @endif
                    <label for="foo">Enter Text to Encrypt</label><br>
                    <input type="text" class="form-control" name="foo" id="foo" placeholder="Enter Text you want to encrypt">
